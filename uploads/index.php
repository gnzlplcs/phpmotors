<?php
  ...
  $image_dir = '/phpmotor/uploads/images';
  ...
  switch ($action) {
    case 'upload':
      ...
      if ($imageCheck) {
        ...
        $message = '<p class="warning-message">You must select a vehicle and image file for the vehicle.</p>';
      } else {
        ...
        if ($result) {
          $message = '<p class="success-message">The upload succeeded.</p>';
        } else {
