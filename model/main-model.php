...
function getClassifications()
{
  ...
  // The next line gets the data from the database and stores it as an array in the $classification variable
  $classifications = $stmt->fetchAll();

  // The next lines closes the interaction with the database
  $stmt->closeCursor();
